    ...
    <footer className="bg-white border-t border-gray-200 py-12">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-sm font-semibold mb-4 text-gray-900 uppercase tracking-wider">Quick Links</h4>
            <ul className="space-y-3">
              <li>
                <a href="#home" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">
                  Home
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#courses" className="text-gray-600 hover:text-gray-900 transition-colors duration-200">
                  Courses
                </a>
              </li>
              <li>
          ...
          {/* Resources */}
          <div>
            <h4 className="text-sm font-semibold mb-4 text-gray-900 uppercase tracking-wider">Resources</h4>
            <ul className="space-y-3">
              <li>
